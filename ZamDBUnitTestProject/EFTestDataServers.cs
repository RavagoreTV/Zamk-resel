    ...
    public class EFTestDataServers
    {
        ...
        private void Seed()
        {
            using (var contex = new ZamDbContext(ContexOptions))
            {
                ...
                contex.Courses.Add(new Course() { CourseId = 1, StartDateTime = new DateTime(2021, 07, 05), EndDateTime = new DateTime(2021, 07, 05), StartLocation = "Roskilde", EndLocation = "Hoblæk", PickUpPoint1 = "Lejre", PickUpPoint2 = "Tølløse", PickUpPoint3 = "Holbæk", ZealandLocation = "Holbæk", UserId = "203d93ad-bc81-4dd8-afcb-76794137058a", AvailableSeats = 3 });
                contex.Courses.Add(new Course() { CourseId = 2, StartDateTime = new DateTime(2021, 07, 05), EndDateTime = new DateTime(2021, 07, 05), StartLocation = "Roskilde", EndLocation = "Hoblæk", PickUpPoint1 = "Lejre", PickUpPoint2 = "Tølløse", PickUpPoint3 = "Roskilde", ZealandLocation = "Roskilde", UserId = "203d93ad-bc81-4dd8-afcb-76794137058a", AvailableSeats = 3 });
                ...
                contex.Bookings.Add(new Booking() { BookingId = 2, Date = new DateTime(2021, 07, 09), ParticipantId = "203d93ad-bc81-4dd8-afcb-76794137058a", CourseId = 2, ChosenPickUpPoint = "Tølløse" });
                contex.SaveChanges();
            }
        }
    }
